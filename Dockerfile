...
ARG THUMBNAIL_QUALITY=100
ARG THUMBNAIL_LOSSLESS=false

ENV SERVER_ADDRESS="127.0.0.1:3000" \
    THUMBNAIL_QUALITY=$THUMBNAIL_QUALITY \
    THUMBNAIL_LOSSLESS=$THUMBNAIL_LOSSLESS \
    EXTERN_LOCATION_IMAGES_STORAGE_PATH=$SCHEME://$DOMAIN/ \
    ...
    EXTERNAL_TO_LOCAL_PATHS_MAP=$SCHEME://$DOMAIN/\|/
